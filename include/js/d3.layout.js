(function(){d3.old_layout = {};
// Implements hierarchical edge bundling using Holten's algorithm. For each
// input link, a path is computed that travels through the tree, up the parent
// hierarchy to the least common ancestor, and then back down to the destination
// node. Each path is simply an array of nodes.
    d3.old_layout.bundle = function() {
...
// A rudimentary force layout using Gauss-Seidel.
    ...
    d3.old_layout.partition = function() {
        var hierarchy = d3.old_layout.hierarchy(),
...
// data is two-dimensional array of x,y; we populate y0
    ...
    d3.old_layout.histogram = function() {
        var frequency = true,
            valuer = Number,
    ...
    d3.old_layout.hierarchy = function() {
...
// For backwards-compatibility, don't enable inlining by default.
    ...
    d3.old_layout.pack = function() {
        var hierarchy = d3.old_layout.hierarchy().sort(d3_layout_packSort),
            size = [1, 1];
...
// Implements a hierarchical layout using the cluster (or dendogram) algorithm.
    d3.old_layout.cluster = function() {
        var hierarchy = d3.old_layout.hierarchy().sort(null).value(null),
...
// Modified to support a target aspect ratio by Jeff Heer
    d3.old_layout.treemap = function() {
        var hierarchy = d3.old_layout.hierarchy(),
            round = Math.round,
            size = [1, 1], // width, height
            padding = null,
